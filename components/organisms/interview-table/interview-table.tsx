...
export function InterviewTable({ data, onInterviewUpdated, onInterviewDeleted }: InterviewTableProps) {
    const [selectedInterview, setSelectedInterview] = React.useState<InterviewResponseDTO | null>(null);
    ...
    return (
        <>
            <DataTable columns={columns} data={data} searchColumn="interviewName" options={statusOptions} />
