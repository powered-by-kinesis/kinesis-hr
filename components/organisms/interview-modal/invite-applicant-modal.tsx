...
import { interviewRepository } from '@/repositories/interview-repository'; // Import interviewRepository
import { InterviewResponseDTO } from '@/types/interview'; // Import InterviewResponseDTO
...
export const InviteApplicantModal: React.FC<InviteApplicantModalProps> = ({ isOpen, onClose, onInviteSuccess, interviewId }) => {
